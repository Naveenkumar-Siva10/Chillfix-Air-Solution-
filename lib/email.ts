...
const FROM_EMAIL = process.env.RESEND_FROM_EMAIL ?? 'info@chillfixairsolution.in';
const TO_EMAIL = process.env.RESEND_TO_EMAIL ?? 'info@chillfixairsolution.in';
    ...
    <body>
      <div class="container">
        <div class="header">
          ...
          <p>ChillFix Air Solution — chillfixairsolution.in</p>
        </div>
        <div class="body">
          <div class="field">
          ...
          <div class="field">
            ...
            <div class="field-value"><a href="tel:${data.phone}" style="color:#0F4C81;text-decoration:none;">+91 ${data.phone}</a></div>
          </div>
          ${data.email ? `
          <div class="field">
        ...
        <div class="footer">
          <p>Received via Contact Form — <strong>chillfixairsolution.in</strong></p>
...
function buildAutoReplyHtml(name: string, service: string): string {
  return `
    ...
    <head>
      <meta charset="UTF-8" />
      <meta name="viewport" content="width=device-width, initial-scale=1.0" />
      <title>We received your request — ChillFix</title>
      <style>
        body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; background: #f4f7f9; margin: 0; padding: 20px; }
        .container { max-width: 600px; margin: 0 auto; background: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.08); }
        ...
        .cta-buttons { display: flex; gap: 12px; margin: 28px 0; }
      ...
      <div class="container">
        ...
        <div class="body">
          ...
          <div class="info-box">
            ...
            <strong>+91 XX XXXX XXXX</strong> — Available 24/7 for emergencies</p>
          </div>
        ...
        <div class="footer">
          ...
          <p style="margin-top:4px;"><a href="https://chillfixairsolution.in" style="color:#0F4C81;">chillfixairsolution.in</a></p>
        </div>
      </div>
    </body>
    </html>
