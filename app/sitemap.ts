...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/ac-service-price-chennai`, lastModified: new Date(), changeFrequency: 'weekly', priority: 0.95 },
  ...
  return [...staticPages, ...serviceTopPages, ...locationTopPages, ...servicePages, ...areaPages, ...blogPages];
}
