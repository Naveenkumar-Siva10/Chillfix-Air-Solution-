...
export function HeroSection() {
  return (
    ...
    >
      ...
      {/* Floating tags */}
      <FloatingTag label="Serving Perungalathur & Chennai" className="right-[24%] top-[22%] hidden 2xl:flex z-10" />
      <FloatingTag label="Fast Local AC Repair" className="right-[8%] bottom-[28%] hidden 2xl:flex z-10" />
      <FloatingTag label="Transparent Pricing" className="right-[4%] top-[32%] hidden 2xl:flex z-10" />
