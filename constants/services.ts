...
export const SERVICES: Service[] = [
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    metaTitle: 'AC Service in Chennai | Starting ₹249 | ChillFix AC Service Chennai',
    metaDescription: 'Book professional AC service in Chennai starting at ₹249. Doorstep technicians for Split & Window ACs, coil jet-wash, filter cleaning, and cooling checks.',
    ...
    description: 'ChillFix AC Service Chennai provides comprehensive AC servicing across Chennai for Split, Window, and Inverter AC units. Regular servicing improves cooling efficiency, reduces electricity bills, and prevents sudden breakdown repairs.',
    icon: 'AirVent',
    ...
    process: [
      ...
      { step: 3, title: 'Drain Clean & Sanitization', description: 'Flushes condensate drain tray and treats coils with clean wash solution.' },
    ...
    faqs: [
      {
        question: 'How much does general AC service cost in Chennai?',
        answer: 'General AC servicing starts at ₹249 with ChillFix AC Service Chennai. Full jet-wash deep cleaning, coil cleaning, and repair options are also available with upfront quotes.',
      },
      {
        question: 'How often should an AC be serviced in Chennai?',
        answer: 'In Chennai climate and dust conditions, an AC should ideally be serviced twice a year (every 5 to 6 months), with basic air filters cleaned every 4 to 6 weeks for optimal cooling and energy efficiency.',
      },
      {
        question: 'What does AC service include?',
        answer: 'Standard AC servicing includes high-pressure jet cleaning of evaporator and condenser coils, air filter washing, drain line flushing to stop leaks, electrical connections inspection, and cooling temperature verification.',
      },
      {
        question: 'Do I need to book an appointment for AC service?',
        answer: 'Yes, you can schedule an appointment by calling +91 90804 95932 or messaging on WhatsApp. A doorstep technician is scheduled at your preferred time.',
      },
      {
        question: 'Do you provide emergency AC service in Chennai?',
        answer: 'Yes, ChillFix AC Service Chennai provides 24/7 emergency AC service and repair support across Perungalathur, Tambaram, and Chennai.',
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    metaTitle: 'AC Repair in Chennai | Doorstep Technicians | ChillFix AC Service Chennai',
    metaDescription: 'Fast doorstep AC repair in Chennai. We fix cooling issues, water leakages, PCB circuit boards, fan motors, and compressor trips with upfront pricing.',
    shortDescription: 'Doorstep diagnostic & breakdown repair service by skilled technicians across Chennai.',
    description: 'When your AC stops cooling or breaks down, ChillFix AC Service Chennai dispatches skilled technicians to your doorstep. We diagnose root causes on-site and provide upfront estimates before starting any repair work.',
    icon: 'Wrench',
    ...
    faqs: [
      {
        ...
        answer: 'Common reasons for an AC not cooling include clogged air filters, refrigerant gas leakage, a faulty start capacitor, dirt-choked condenser coils, or a malfunctioning compressor. A technician inspection pinpoints the exact cause.',
      },
      {
        question: 'Why is my AC leaking water inside the room?',
        answer: 'Water leakage inside the room is usually caused by a choked condensate drain pipe, an unlevel drain tray, cracked drainage tubing, or frozen evaporator coils due to low refrigerant gas.',
      },
      {
        question: 'When should an AC be repaired?',
        answer: 'You should repair your AC if it blows warm air, repeatedly trips the MCB circuit breaker, produces unusual grinding or rattling sounds, leaks water, or displays blinking error codes.',
      },
      {
        question: 'Do you provide emergency AC repair in Chennai?',
        answer: 'Yes, 24/7 emergency AC repair is available across Chennai. Call +91 90804 95932 or reach out on WhatsApp for prompt technician assistance.',
      },
    ],
  },
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    metaDescription: 'Heavy-duty foam jet-wash AC deep cleaning in Chennai. Cleans hidden indoor & outdoor coil dirt, restores lost cooling, and eliminates bacteria.',
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    metaDescription: 'Affordable AC gas filling in Chennai. We detect & braze copper pipe gas leaks first, then refill R32, R410A, or R22 gas with pressure testing.',
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    metaDescription: 'Professional AC installation in Chennai starting at ₹599. Core drilling, heavy-duty outdoor bracket fitting, vacuuming, and testing by skilled technicians.',
    shortDescription: 'Professional Split & Window AC installation with heavy-duty mounting, copper piping, and safety testing.',
    description: 'Improper AC installation causes premature AC failures, gas leaks, and high power bills. ChillFix delivers precision AC installation in Chennai with wall bracket mounting, core hole drilling, insulation wrapping, and post-fitting vacuum testing.',
    icon: 'Wrench',
  ...
  // ─────────────────────────────────────────────────────────────
  {
    ...
    metaDescription: 'Worry-free Annual AC Maintenance Contracts (AMC) in Chennai for home & office. Includes 3-4 jet wash services, priority emergency repair, and spare discounts.',
    shortDescription: 'Annual AC maintenance contracts for residential & commercial spaces across Chennai.',
    description: 'Avoid sudden AC breakdowns in Chennai summers with a ChillFix Annual Maintenance Contract (AMC). Enjoy scheduled preventive servicing, free breakdown labor calls, and priority emergency support all year round.',
    icon: 'CalendarCheck',
    ...
    features: [
      ...
      'Free breakdown repair labor visits',
      'Priority emergency dispatch support',
      'Discount on spare parts & gas filling',
