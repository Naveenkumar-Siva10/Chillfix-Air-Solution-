...
export const NAV_ITEMS: NavItem[] = [
  ...
  },
  {
    ...
    href: '/services',
    children: [
      { label: 'AC Service New Perungalathur', href: '/service-areas/new-perungalathur' },
      { label: 'AC Service Perungalathur (Hub)', href: '/service-areas/perungalathur' },
      { label: 'AC Service Vandalur & Otteri', href: '/service-areas/vandalur' },
...
export const FOOTER_NAV = {
  ...
  locations: [
    { label: 'New Perungalathur AC Service', href: '/service-areas/new-perungalathur' },
    { label: 'Perungalathur Hub AC Service', href: '/service-areas/perungalathur' },
    { label: 'Vandalur & Otteri AC Service', href: '/service-areas/vandalur' },
